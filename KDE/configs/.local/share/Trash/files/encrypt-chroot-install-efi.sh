...
echo -e 'title    BK ARCH\nlinux    /vmlinuz-linux\ninitrd    /initramfs-linux.img\noptions    cryptdevice=UUID='$diskuuid':lvm:allow-discards resume=/dev/mapper/vol0-lv_swap root=/dev/mapper/vol0-lv_root rw quiet' > /boot/loader/entries/arch.conf
bootctl update
