...
sed -i 's|    MENU LABEL Arch Linux|    MENU LABEL BK ARCH|g' /boot/syslinux/syslinux.cfg
sed -i 's|    MENU LABEL Arch Linux Fallback|    MENU LABEL BK ARCH fallback|g' /boot/syslinux/syslinux.cfg
