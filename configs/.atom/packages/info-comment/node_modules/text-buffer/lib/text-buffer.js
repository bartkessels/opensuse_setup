(function() {
  var CompositeDisposable, Emitter, File, History, MarkerLayer, MatchIterator, Patch, Point, Range, SearchCallbackArgument, Serializable, SpanSkipList, TextBuffer, TransactionAbortedError, crypto, diff, fs, newlineRegex, path, spliceArray, _, _ref, _ref1,
  ...
  module.exports = TextBuffer = (function() {
    ...
    function TextBuffer(params) {
      var maxUndoEntries, text, _ref10, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      if (typeof params === 'string') {
        text = params;
      }
      this.emitter = new Emitter;
      this.id = (_ref2 = params != null ? params.id : void 0) != null ? _ref2 : crypto.randomBytes(16).toString('hex');
      this.lines = [''];
      this.lineEndings = [''];
      this.offsetIndex = new SpanSkipList('rows', 'characters');
      this.setTextInRange([[0, 0], [0, 0]], (_ref3 = text != null ? text : params != null ? params.text : void 0) != null ? _ref3 : '', {
        normalizeLineEndings: false
      });
      maxUndoEntries = (_ref4 = params != null ? params.maxUndoEntries : void 0) != null ? _ref4 : this.defaultMaxUndoEntries;
      this.history = (_ref5 = params != null ? params.history : void 0) != null ? _ref5 : new History(this, maxUndoEntries);
      this.nextMarkerLayerId = (_ref6 = params != null ? params.nextMarkerLayerId : void 0) != null ? _ref6 : 0;
      this.defaultMarkerLayer = (_ref7 = params != null ? params.defaultMarkerLayer : void 0) != null ? _ref7 : new MarkerLayer(this, String(this.nextMarkerLayerId++));
      this.markerLayers = (_ref8 = params != null ? params.markerLayers : void 0) != null ? _ref8 : {};
      this.markerLayers[this.defaultMarkerLayer.id] = this.defaultMarkerLayer;
      this.nextMarkerId = (_ref9 = params != null ? params.nextMarkerId : void 0) != null ? _ref9 : 1;
      ...
      this.digestWhenLastPersisted = (_ref10 = params != null ? params.digestWhenLastPersisted : void 0) != null ? _ref10 : false;
